...
// Données FAQ partagées — fichier neutre (pas de "use client") pour rester
// importable côté serveur (schéma FAQPage JSON-LD) ET côté client (accordéon).
export const FAQ_DATA = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Que couvre exactement l'entretien ménager ?", a: "L'entretien comprend le ménage complet (dépoussiérage, aspiration, lavage des sols), le nettoyage des surfaces et plans de travail, la désinfection des pièces humides (WC, salle de bain) et le nettoyage des vitres. Le repassage est proposé séparément, à la pièce (Rivière-Salée). Chaque intervention est adaptée à votre domicile et vos priorités." },
