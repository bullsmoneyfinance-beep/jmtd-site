...
export const SERVICES = [
  {
    ...
    short: "Ménage complet, linge, vitres, sols",
  ...
  },
  {
    ...
    short: "Méthode Marie Kondo · 42€/h",
    desc: "Inspirée de la méthode Marie Kondo, notre spécialiste du rangement étudie vos besoins, vos habitudes de vie et vos attentes. Un diagnostic-conseil offert nous permet de vous présenter le travail à réaliser, puis nous intervenons à 42€/h (+ 15€ de frais de déplacement).",
    details: [
