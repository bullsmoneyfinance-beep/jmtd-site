...
export const AMBER = "#0DA9A4";       // teal principal (couleur "TD" du logo)
...
export const WHATSAPP = "https://wa.me/33596631308";
...
export const SERVICES = [
  {
    ...
    desc: "L'équipe J'MTD se déplace chez vous à Rivière-Salée, au Diamant, au Lamentin et partout en Martinique pour l'entretien et le nettoyage complet de votre intérieur. Travail sérieux, discret et toujours avec le sourire.",
    details: [
  ...
  },
  {
    ...
    desc: "J'MTD s'occupe de vos commissions selon votre liste et vous les livre directement chez vous, dans les délais convenus. De Rivière-Salée à Saint-Esprit, nous intervenons partout en Martinique.",
    details: [
      "Courses selon votre liste personnalisée",
      "Livraison à domicile sur toute la Martinique",
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=500&h=350&fit=crop&auto=format",
    special: true,
  },
];
...
// ─── Zones ───
export const ZONES = [
  "Centre (Lamentin / Rivière-Salée)",
  "Nord Atlantique",
  "Nord Caraïbe",
  "Sud (Diamant / Saint-Esprit)",
  "Toute la Martinique",
];
...
export const TESTIMONIALS = [
  {
    ...
    city: "Fort-de-France",
    stars: 5,
    text: "J'MTD a complètement transformé mon quotidien. Myriam et son équipe sont professionnelles, discrètes et toujours souriantes. Mon domicile n'a jamais été aussi propre. Je recommande vivement !",
  },
  {
    name: "Jean-Luc B.",
    city: "Rivière-Salée",
    stars: 5,
    text: "Service impeccable et ponctuel. Le coaching en rangement de la méthode Marie Kondo a complètement changé notre espace de vie. On retrouve enfin nos affaires ! Merci à toute l'équipe.",
  },
  {
    name: "Claudine M.",
    city: "Le Diamant",
    stars: 5,
    text: "Enfin un service à la personne fiable en Martinique ! La livraison de courses me fait gagner un temps précieux chaque semaine. En plus, grâce au crédit d'impôt, ça ne coûte presque rien !",
  },
];
